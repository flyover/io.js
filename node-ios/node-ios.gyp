...
#        ], # conditions
    ...
    'targets': [
        {
            ...
            'xcode_settings': {
                ...
                'SOURCE_FILE_NAMES_ARM': 'deps/v8/src/arm/* deps/v8/src/compiler/arm/* deps/v8/src/ic/arm/*',
                'SOURCE_FILE_NAMES_ARM64': 'deps/v8/src/arm64/* deps/v8/src/compiler/arm64/* deps/v8/src/ic/arm64/*',
                'SOURCE_FILE_NAMES_IA32': 'deps/v8/src/ia32/* deps/v8/src/compiler/ia32/* deps/v8/src/ic/ia32/*',
                'SOURCE_FILE_NAMES_X64': 'deps/v8/src/x64/* deps/v8/src/compiler/x64/* deps/v8/src/ic/x64/*',
                'EXCLUDED_SOURCE_FILE_NAMES': '',
                #'EXCLUDED_SOURCE_FILE_NAMES[sdk=iphonesimulator*]': '$(SOURCE_FILE_NAMES_ARM) $(SOURCE_FILE_NAMES_ARM64) $(SOURCE_FILE_NAMES_X64)',
                'EXCLUDED_SOURCE_FILE_NAMES[arch=i386]': '$(SOURCE_FILE_NAMES_ARM) $(SOURCE_FILE_NAMES_ARM64) $(SOURCE_FILE_NAMES_X64)',
                'EXCLUDED_SOURCE_FILE_NAMES[arch=x86_64]': '$(SOURCE_FILE_NAMES_ARM) $(SOURCE_FILE_NAMES_ARM64) $(SOURCE_FILE_NAMES_IA32)',
                'EXCLUDED_SOURCE_FILE_NAMES[arch=armv7]': '$(SOURCE_FILE_NAMES_ARM64) $(SOURCE_FILE_NAMES_IA32) $(SOURCE_FILE_NAMES_X64)',
                'EXCLUDED_SOURCE_FILE_NAMES[arch=armv7s]': '$(SOURCE_FILE_NAMES_ARM64) $(SOURCE_FILE_NAMES_IA32) $(SOURCE_FILE_NAMES_X64)',
                'EXCLUDED_SOURCE_FILE_NAMES[arch=arm64]': '$(SOURCE_FILE_NAMES_ARM) $(SOURCE_FILE_NAMES_IA32) $(SOURCE_FILE_NAMES_X64)',
            }, # xcode_settings
            'configurations': {
                'Debug': {
                    'xcode_settings': {
            ...
            'actions': [
                {
                    'action_name': 'node-ios.mk',
                    'variables': {},
                    'inputs': [],
                    'outputs': [],
                    'action': [ 'make', '-f', 'node-ios.mk', 'build' ],
                },
            ], # actions
            'include_dirs': [
                '../src',
                '../node-ios/gen/node-ios',
                '../deps/uv/src',
                '../deps/uv/include',
                '../deps/v8',
                '../deps/v8/include',
            ...
            'sources': [
                '<@(node_sources)',
                '../node-ios/gen/node-ios/node_natives.h',
                '../node-ios/gen/node-ios/libraries.cc',
                '../node-ios/gen/node-ios/experimental-libraries.cc',
                '../node-ios/gen/node-ios/debug-support.cc',
                '<@(uv_sources)',
                '<@(v8_sources)',
                '<@(cares_sources)',
                '<@(http_parser_sources)',
        ...
        },
        {
            ...
            'actions': [
                {
                    ...
                    'inputs': [],
                    'outputs': [],
                    'action': [ 'make', '-f', 'node-ios.mk', 'build', 'USE_V8LIKE=1' ],
                },
            ], # actions
            'include_dirs': [
                '../src',
                '../node-ios/gen/nodelike-ios',
                '../deps/uv/src',
                '../deps/uv/include',
                '../../v8like/include',
                '../deps/cares/include',
            ...
            'sources': [
                '<@(node_sources)',
                '../node-ios/gen/nodelike-ios/node_natives.h',
                '../node-ios/gen/nodelike-ios/libraries.cc',
                '../node-ios/gen/nodelike-ios/experimental-libraries.cc',
                '../node-ios/gen/nodelike-ios/debug-support.cc',
                '<@(uv_sources)',
    ...
    'variables': {
        ...
        'v8_sources': [
            ...
            '../deps/v8/src/runtime/runtime-api.cc',
            ...
            '../deps/v8/src/ic/arm64/access-compiler-arm64.cc',
            ...
            '../deps/v8/src/ic/ia32/access-compiler-ia32.cc',
            ...
            #'../deps/v8/src/ic/mips/access-compiler-mips.cc',
            ...
            #'../deps/v8/src/mips64/frames-mips64.cc',
            ...
            #'../deps/v8/src/mips64/lithium-gap-resolver-mips64.cc',
            #'../deps/v8/src/mips64/lithium-mips64.cc',
            #'../deps/v8/src/mips64/macro-assembler-mips64.cc',
            #'../deps/v8/src/mips64/regexp-macro-assembler-mips64.cc',
            ...
            #'../deps/v8/src/ic/mips64/access-compiler-mips64.cc',
            ...
            #'../deps/v8/src/ppc/lithium-gap-resolver-ppc.cc',
            #'../deps/v8/src/ppc/lithium-ppc.cc',
            #'../deps/v8/src/ppc/macro-assembler-ppc.cc',
            #'../deps/v8/src/ppc/regexp-macro-assembler-ppc.cc',
            #'../deps/v8/src/ppc/simulator-ppc.cc',
            #'../deps/v8/src/ic/ppc/access-compiler-ppc.cc',
            #'../deps/v8/src/ic/ppc/handler-compiler-ppc.cc',
            #'../deps/v8/src/ic/ppc/ic-compiler-ppc.cc',
            #'../deps/v8/src/ic/ppc/ic-ppc.cc',
            #'../deps/v8/src/ic/ppc/stub-cache-ppc.cc',
