...
CARES_SRC_FILES := $(NODE_PATH)/deps/cares/common.gypi
CARES_SRC_FILES += $(NODE_PATH)/deps/cares/include/ares.h
CARES_SRC_FILES += $(NODE_PATH)/deps/cares/include/ares_version.h
CARES_SRC_FILES += $(NODE_PATH)/deps/cares/include/nameser.h
...
CARES_SRC_FILES += $(NODE_PATH)/deps/cares/src/ares_data.h
CARES_SRC_FILES += $(NODE_PATH)/deps/cares/src/ares_destroy.c
CARES_SRC_FILES += $(NODE_PATH)/deps/cares/src/ares_dns.h
...
CARES_SRC_FILES += $(NODE_PATH)/deps/cares/src/ares_getenv.h
...
CARES_SRC_FILES += $(NODE_PATH)/deps/cares/src/ares_platform.h
CARES_SRC_FILES += $(NODE_PATH)/deps/cares/src/ares_private.h
...
CARES_SRC_FILES += $(NODE_PATH)/deps/cares/src/ares_rules.h
CARES_SRC_FILES += $(NODE_PATH)/deps/cares/src/ares_search.c
CARES_SRC_FILES += $(NODE_PATH)/deps/cares/src/ares_send.c
CARES_SRC_FILES += $(NODE_PATH)/deps/cares/src/ares_setup.h
CARES_SRC_FILES += $(NODE_PATH)/deps/cares/src/ares_strcasecmp.c
CARES_SRC_FILES += $(NODE_PATH)/deps/cares/src/ares_strcasecmp.h
CARES_SRC_FILES += $(NODE_PATH)/deps/cares/src/ares_strdup.c
CARES_SRC_FILES += $(NODE_PATH)/deps/cares/src/ares_strdup.h
...
CARES_SRC_FILES += $(NODE_PATH)/deps/cares/src/ares_writev.h
CARES_SRC_FILES += $(NODE_PATH)/deps/cares/src/bitncmp.c
CARES_SRC_FILES += $(NODE_PATH)/deps/cares/src/bitncmp.h
CARES_SRC_FILES += $(NODE_PATH)/deps/cares/src/inet_net_pton.c
CARES_SRC_FILES += $(NODE_PATH)/deps/cares/src/inet_ntop.c
CARES_SRC_FILES += $(NODE_PATH)/deps/cares/src/ares_inet_net_pton.h
CARES_SRC_FILES += $(NODE_PATH)/deps/cares/src/setup_once.h
CARES_SRC_FILES += $(NODE_PATH)/deps/cares/src/windows_port.c
CARES_SRC_FILES += $(NODE_PATH)/deps/cares/config/android/ares_config.h
...
LOCAL_CFLAGS := $(CARES_CFLAGS)
LOCAL_CPPFLAGS := $(CARES_CPPFLAGS)
...
LOCAL_SRC_FILES := $(filter %.c,$(CARES_SRC_FILES))
...
CHROME_ZLIB_SRC_FILES += $(NODE_PATH)/deps/zlib/crc32.h
CHROME_ZLIB_SRC_FILES += $(NODE_PATH)/deps/zlib/deflate.c
CHROME_ZLIB_SRC_FILES += $(NODE_PATH)/deps/zlib/deflate.h
CHROME_ZLIB_SRC_FILES += $(NODE_PATH)/deps/zlib/gzclose.c
CHROME_ZLIB_SRC_FILES += $(NODE_PATH)/deps/zlib/gzguts.h
...
CHROME_ZLIB_SRC_FILES += $(NODE_PATH)/deps/zlib/inffast.h
CHROME_ZLIB_SRC_FILES += $(NODE_PATH)/deps/zlib/inffixed.h
CHROME_ZLIB_SRC_FILES += $(NODE_PATH)/deps/zlib/inflate.c
CHROME_ZLIB_SRC_FILES += $(NODE_PATH)/deps/zlib/inflate.h
CHROME_ZLIB_SRC_FILES += $(NODE_PATH)/deps/zlib/inftrees.c
CHROME_ZLIB_SRC_FILES += $(NODE_PATH)/deps/zlib/inftrees.h
CHROME_ZLIB_SRC_FILES += $(NODE_PATH)/deps/zlib/trees.c
CHROME_ZLIB_SRC_FILES += $(NODE_PATH)/deps/zlib/trees.h
CHROME_ZLIB_SRC_FILES += $(NODE_PATH)/deps/zlib/uncompr.c
CHROME_ZLIB_SRC_FILES += $(NODE_PATH)/deps/zlib/zconf.h
CHROME_ZLIB_SRC_FILES += $(NODE_PATH)/deps/zlib/zlib.h
CHROME_ZLIB_SRC_FILES += $(NODE_PATH)/deps/zlib/zutil.c
CHROME_ZLIB_SRC_FILES += $(NODE_PATH)/deps/zlib/zutil.h
...
LOCAL_SRC_FILES := $(filter %.c,$(CHROME_ZLIB_SRC_FILES))
...
UV_SRC_FILES := $(NODE_PATH)/deps/uv/common.gypi
UV_SRC_FILES += $(NODE_PATH)/deps/uv/include/uv.h
UV_SRC_FILES += $(NODE_PATH)/deps/uv/include/tree.h
UV_SRC_FILES += $(NODE_PATH)/deps/uv/include/uv-errno.h
UV_SRC_FILES += $(NODE_PATH)/deps/uv/include/uv-threadpool.h
UV_SRC_FILES += $(NODE_PATH)/deps/uv/include/uv-version.h
UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/fs-poll.c
UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/heap-inl.h
UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/inet.c
UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/queue.h
UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/threadpool.c
UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/uv-common.c
UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/uv-common.h
UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/version.c

UV_SRC_FILES += $(NODE_PATH)/deps/uv/include/uv-unix.h
UV_SRC_FILES += $(NODE_PATH)/deps/uv/include/uv-linux.h
UV_SRC_FILES += $(NODE_PATH)/deps/uv/include/uv-sunos.h
UV_SRC_FILES += $(NODE_PATH)/deps/uv/include/uv-darwin.h
UV_SRC_FILES += $(NODE_PATH)/deps/uv/include/uv-bsd.h
UV_SRC_FILES += $(NODE_PATH)/deps/uv/include/uv-aix.h
UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/unix/async.c
UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/unix/atomic-ops.h
...
UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/unix/internal.h
...
UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/unix/spinlock.h
...
UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/unix/linux-syscalls.h
...
LOCAL_SRC_FILES := $(filter %.c,$(UV_SRC_FILES))
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ast-this-access-visitor.h
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ast-numbering.h
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/background-parsing-task.h
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/bailout-reason.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/bailout-reason.h
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/basic-block-profiler.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/basic-block-profiler.h
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/bit-vector.h
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/code-factory.h
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compilation-statistics.h
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/access-builder.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/access-builder.h
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/ast-loop-assignment-analyzer.h
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/basic-block-instrumentor.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/basic-block-instrumentor.h
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/change-lowering.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/change-lowering.h
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/common-operator-reducer.h
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/control-equivalence.h
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/control-reducer.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/control-reducer.h
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/diamond.h
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/js-builtin-reducer.h
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/js-inlining.h
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/js-intrinsic-builder.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/js-intrinsic-builder.h
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/jump-threading.h
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/load-elimination.h
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/loop-analysis.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/loop-analysis.h
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/move-optimizer.h
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/pipeline-statistics.h
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/register-allocator-verifier.h
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/register-configuration.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/register-configuration.h
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/select-lowering.h
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/simplified-operator-reducer.h
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/value-numbering-reducer.h
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/zone-pool.h
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/heap/gc-idle-time-handler.h
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/access-compiler.h
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/call-optimization.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/call-optimization.h
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/handler-compiler.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/handler-compiler.h
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/ic-inl.h
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/ic-state.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/ic-state.h
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/ic.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/ic.h
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/ic-compiler.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/ic-compiler.h
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/interface-descriptors.h
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/layout-descriptor-inl.h
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/layout-descriptor.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/layout-descriptor.h
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/runtime/runtime-utils.h
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/runtime/runtime.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/runtime/runtime.h
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/string-builder.h
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/stub-cache.h
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/type-feedback-vector-inl.h
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/type-feedback-vector.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/type-feedback-vector.h
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/unicode-decoder.h
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/third_party/fdlibm/fdlibm.h
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/arm/interface-descriptors-arm.h
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/arm64/interface-descriptors-arm64.h
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/mips/instruction-codes-mips.h
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/mips64/instruction-codes-mips64.h
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/base/bits.h
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/base/build_config.h
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/base/compiler-specific.h
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/base/division-by-constant.h
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/base/flags.h
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/base/functional.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/base/functional.h
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/base/iterator.h
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/base/sys-info.h
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/include/libplatform/libplatform.h
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/libplatform/default-platform.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/libplatform/default-platform.h
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/libplatform/task-queue.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/libplatform/task-queue.h
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/libplatform/worker-thread.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/libplatform/worker-thread.h
