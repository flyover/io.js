...
NODE_COMMON_CFLAGS += '-D_LARGEFILE64_SOURCE'
...
NODE_COMMON_CPPFLAGS += -std=gnu++0x
...
NODE_CFLAGS += '-DNODE_ARCH="$(TARGET_ARCH)"'
NODE_CFLAGS += '-DNODE_PLATFORM="android"'
...
NODE_SRC_FILES += $(NODE_PATH)/src/debug-agent.cc
...
NODE_SRC_FILES += $(NODE_PATH)/src/node_v8_platform.cc
...
OPENSSL_CFLAGS += '-DOPENSSL_NO_SSL2'
OPENSSL_CFLAGS += '-DOPENSSL_NO_SSL3'
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ast-numbering.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ast-this-access-visitor.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ast-value-factory.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/background-parsing-task.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/bailout-reason.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/base/atomicops_internals_x86_gcc.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/base/bits.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/base/cpu.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/base/division-by-constant.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/base/functional.cc
...
#V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/base/platform/platform-cygwin.cc
#V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/base/platform/platform-freebsd.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/base/platform/platform-linux.cc
#V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/base/platform/platform-macos.cc
#V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/base/platform/platform-openbsd.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/base/platform/platform-posix.cc
#V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/base/platform/platform-qnx.cc
#V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/base/platform/platform-solaris.cc
#V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/base/platform/platform-win32.cc
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/char-predicates.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/checks.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/code-factory.cc
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compilation-statistics.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/access-builder.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/ast-graph-builder.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/ast-loop-assignment-analyzer.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/basic-block-instrumentor.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/change-lowering.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/code-generator.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/common-node-cache.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/common-operator.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/common-operator-reducer.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/control-builders.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/control-reducer.cc
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/js-builtin-reducer.cc
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/js-inlining.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/js-intrinsic-builder.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/js-operator.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/js-typed-lowering.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/jump-threading.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/linkage.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/load-elimination.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/loop-analysis.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/machine-operator.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/machine-operator-reducer.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/machine-type.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/move-optimizer.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/node.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/node-cache.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/opcodes.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/operator.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/operator-properties.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/pipeline.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/pipeline-statistics.cc
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/register-allocator-verifier.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/register-configuration.cc
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/select-lowering.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/simplified-lowering.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/simplified-operator.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/simplified-operator-reducer.cc
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/value-numbering-reducer.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/verifier.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/zone-pool.cc
...
#V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/d8.cc
#V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/d8-debug.cc
#V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/d8-posix.cc
#V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/d8-readline.cc
#V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/d8-windows.cc
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/heap/gc-idle-time-handler.cc
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/access-compiler.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/call-optimization.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/handler-compiler.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/ic.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/ic-compiler.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/ic-state.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/stub-cache.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/icu_util.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/interface.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/interface-descriptors.cc
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/layout-descriptor.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/libplatform/default-platform.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/libplatform/task-queue.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/libplatform/worker-thread.cc
...
#V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/mksnapshot.cc
#V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/natives-external.cc
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/runtime/runtime.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/runtime/runtime-api.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/runtime/runtime-array.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/runtime/runtime-classes.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/runtime/runtime-collections.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/runtime/runtime-compiler.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/runtime/runtime-date.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/runtime/runtime-debug.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/runtime/runtime-function.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/runtime/runtime-generator.cc
#V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/runtime/runtime-i18n.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/runtime/runtime-internal.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/runtime/runtime-json.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/runtime/runtime-literals.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/runtime/runtime-liveedit.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/runtime/runtime-maths.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/runtime/runtime-numbers.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/runtime/runtime-object.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/runtime/runtime-observe.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/runtime/runtime-proxy.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/runtime/runtime-regexp.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/runtime/runtime-scopes.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/runtime/runtime-strings.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/runtime/runtime-symbol.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/runtime/runtime-test.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/runtime/runtime-typedarray.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/runtime/runtime-uri.cc
...
#V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/snapshot-empty.cc
#V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/snapshot-external.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/snapshot-source-sink.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/string-builder.cc
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/third_party/fdlibm/fdlibm.cc
#V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/third_party/vtune/jitprofiling.cc
#V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/third_party/vtune/vtune-jit.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/token.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/transitions.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/type-feedback-vector.cc
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/unicode-decoder.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/utils.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/v8.cc
#V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/v8dll-main.cc
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/arm/interface-descriptors-arm.cc
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/arm/access-compiler-arm.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/arm/handler-compiler-arm.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/arm/ic-arm.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/arm/ic-compiler-arm.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/arm/stub-cache-arm.cc
endif
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/arm64/interface-descriptors-arm64.cc
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/arm64/access-compiler-arm64.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/arm64/handler-compiler-arm64.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/arm64/ic-arm64.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/arm64/ic-compiler-arm64.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/arm64/stub-cache-arm64.cc
endif
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ia32/interface-descriptors-ia32.cc
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/ia32/access-compiler-ia32.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/ia32/handler-compiler-ia32.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/ia32/ic-compiler-ia32.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/ia32/ic-ia32.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/ia32/stub-cache-ia32.cc
endif
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/mips/interface-descriptors-mips.cc
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/mips/code-generator-mips.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/mips/instruction-selector-mips.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/mips/linkage-mips.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/mips/access-compiler-mips.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/mips/handler-compiler-mips.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/mips/ic-compiler-mips.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/mips/ic-mips.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/mips/stub-cache-mips.cc
endif
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/mips64/interface-descriptors-mips64.cc
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/mips64/code-generator-mips64.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/mips64/instruction-selector-mips64.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/compiler/mips64/linkage-mips64.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/mips64/access-compiler-mips64.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/mips64/handler-compiler-mips64.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/mips64/ic-compiler-mips64.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/mips64/ic-mips64.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/mips64/stub-cache-mips64.cc
endif

ifeq ($(TARGET_ARCH),ppc)
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ppc/assembler-ppc.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ppc/builtins-ppc.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ppc/codegen-ppc.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ppc/code-stubs-ppc.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ppc/constants-ppc.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ppc/cpu-ppc.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ppc/debug-ppc.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ppc/deoptimizer-ppc.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ppc/disasm-ppc.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ppc/frames-ppc.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ppc/full-codegen-ppc.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ppc/interface-descriptors-ppc.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ppc/lithium-codegen-ppc.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ppc/lithium-gap-resolver-ppc.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ppc/lithium-ppc.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ppc/macro-assembler-ppc.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ppc/regexp-macro-assembler-ppc.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ppc/simulator-ppc.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/ppc/access-compiler-ppc.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/ppc/handler-compiler-ppc.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/ppc/ic-compiler-ppc.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/ppc/ic-ppc.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/ppc/stub-cache-ppc.cc
endif
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/x64/interface-descriptors-x64.cc
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/x64/access-compiler-x64.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/x64/handler-compiler-x64.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/x64/ic-compiler-x64.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/x64/ic-x64.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/x64/stub-cache-x64.cc
endif
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/x87/interface-descriptors-x87.cc
...
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/x87/simulator-x87.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/x87/access-compiler-x87.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/x87/handler-compiler-x87.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/x87/ic-compiler-x87.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/x87/ic-x87.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/ic/x87/stub-cache-x87.cc
endif
...
$(eval $(NODE_ANDROID_ROOT)/$(NODE_GEN_PATH)/libraries.cc: $(addprefix $(NODE_ANDROID_ROOT)/,$(V8_LIBRARY_FILES)) ;\
	mkdir -p $$(@D) && python $(NODE_ROOT)/deps/v8/tools/js2c.py $$@ CORE $(addprefix $(NODE_ANDROID_ROOT)/,$(V8_LIBRARY_FILES)) )
...
$(eval $(NODE_ANDROID_ROOT)/$(NODE_GEN_PATH)/experimental-libraries.cc: $(addprefix $(NODE_ANDROID_ROOT)/,$(V8_EXPERIMENTAL_LIBRARY_FILES)) ;\
	mkdir -p $$(@D) && python $(NODE_ROOT)/deps/v8/tools/js2c.py $$@ EXPERIMENTAL $(addprefix $(NODE_ANDROID_ROOT)/,$(V8_EXPERIMENTAL_LIBRARY_FILES)) )
